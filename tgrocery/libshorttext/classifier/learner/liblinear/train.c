...
void parse_command_line(INT64 argc, char **argv, char *input_file_name, char *model_file_name);
...
int main(int argc, char **argv)
{
	...
	parse_command_line((INT64)argc, argv, input_file_name, model_file_name);
...
void parse_command_line(INT64 argc, char **argv, char *input_file_name, char *model_file_name)
{
	...
	for(i=1;i<argc;i++)
	{
		...
		switch(argv[i-1][1])
		{
			...
			case 'w':
				++param.nr_weight;
				param.weight_label = (INT64 *) realloc(param.weight_label,sizeof(INT64)*param.nr_weight);
